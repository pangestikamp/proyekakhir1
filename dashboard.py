...
with col1:
    ...
    def main():
      ...
      plt.xlabel('Humidity')
      plt.ylabel('Count')
      plt.title('Hubungan antara Humidity dengan Total Banyaknya Peminjam Sepeda')
      st.pyplot(plt)
    if __name__ == '__main__':
       main()
...
with col2:
    ...
    def main():
      ...
      plt.ylabel('Count')
      plt.title('Hubungan antara Temperature dengan Total Banyaknya Peminjam Sepeda')
      st.pyplot(plt)
    if __name__ == '__main__':
        main()
...
with col1:
    def main():
      ...
      plt.ylabel('Count')
      plt.title('Hubungan antara Apparent Temperature dengan Total Banyaknya Peminjam Sepeda')
      st.pyplot(plt)
    if __name__ == '__main__':
       main()
...
with col2:
    def main():
      ...
      plt.ylabel('Count')
      plt.title('Hubungan antara Windspeed dengan Total Banyaknya Peminjam Sepeda')
      st.pyplot(plt)
    if __name__ == '__main__':
        main()
